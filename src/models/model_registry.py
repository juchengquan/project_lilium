...
try:
    from ._mixins import createClass
    ...
    ModelLM = createClass(mixin_list)
    # Dynamically add loading methods
    ModelLM.load_model = staticmethod(_model.load_model)
    ModelLM.load_tokenizer = staticmethod(_model.load_tokenizer)
